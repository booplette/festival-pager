#!/bin/bash
# Festival Pager — Wrapper: starts notifier loop and web UI
#
# This is run by systemd via festival-pager.service.
# Starts both the schedule notifier (background) and the Flask web UI (foreground).
